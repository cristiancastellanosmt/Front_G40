function getMensajes(){
    $.ajax({
        url:"http://168.138.231.33:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function postMensajes(){
    if ($("#messageText").val().length==0){
        ...
        $.ajax({
            url:"http://168.138.231.33:8080/api/Message/save",
            type:"POST",
            datatype:"JSON",
...
function putMensajes(idBotonActualizar){
    ...
    if ($("#messageText").val().length==0){
        ...
        $.ajax({
            url:"http://168.138.231.33:8080/api/Message/update",
            type:"PUT",
            datatype:"JSON",
...
function deleteMensajes(idBotonBorrar){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url:"http://168.138.231.33:8080/api/Message/"+ idBotonBorrar,
                type:"DELETE",
                datatype:"JSON",
